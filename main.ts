...
let name1 : string = "ayEsha NazeeR"
...
let names : string[] = ["Sana", "Ayesha", "Iqra"]
...
let fav_transport : string[] = ["Vigo", "Toyota",  "Civic"]
...
let guest : string[] = ["Aqsa", "Sobia", "Areeba", "Esha"]
guest.forEach(guest => {
...
let chng : string = "Esha";
console.log(`${chng} is unable to attend Dinner Party.`)
...
//ANSWER 16:
let guests : string[] = ["Saima", "Noor", "Aliza", "Urooj"];
...
//ANSWER 18:
let places : string[] = ["Turkey", "saudi Arabia", "London", "Dubai", "China"]
...
let cities : string[] = ["Karachi", "Islamabad", "Quetta", "Multan", "Sialkot"];
//My try
...
console.log(`My name is ${myself.name}, i am from ${myself.city} and i am ${myself.age} years ago.`)
...
let animals : string[] = ["Cat", "Monkey", "Cow", "Lion", "Zeebra", "Camel"]
...
//Another Example
console.log("\n Another Example");
let secA : string[] = ["sana", "areeba", "hira", "nimra", "arisha"];
let secB : string[] = ["iqra", "sahiba", "nadia", "komal", "beenish"];
secB.forEach(secB => {
...
let pizzas : string[] = ["Margherita", "Veggie", "Pepperoni", "Mexico"];
...
let magicians : string[] = ["Harry", "Houdini", "Dynamo"];
...
console.log("\n q43");
let magicians1 : string[] = ["Teller", "Harry", "Houdini"];
